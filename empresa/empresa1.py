...
class PredictEmprestimo(object):
    def __init__(self):
        self.idade                                  = pickle.load(open('../6_Projeto_Integrador_I/parameter/idade_scaler.pkl', 'rb'))
        self.renda                                  = pickle.load(open('../6_Projeto_Integrador_I/parameter/renda_scaler.pkl', 'rb'))
        self.tempo_emprego                          = pickle.load(open('../6_Projeto_Integrador_I/parameter/tempo_emprego_scaler.pkl', 'rb'))
        self.valor_emprestimo                       = pickle.load(open('../6_Projeto_Integrador_I/parameter/valor_emprestimo_scaler.pkl', 'rb'))
        self.taxa_juros_emprestimo                  = pickle.load(open('../6_Projeto_Integrador_I/parameter/taxa_juros_emprestimo_scaler.pkl', 'rb'))
        self.relacao_emprestimo_renda               = pickle.load(open('../6_Projeto_Integrador_I/parameter/relacao_emprestimo_renda_scaler.pkl', 'rb'))
        self.historico_credito                      = pickle.load(open('../6_Projeto_Integrador_I/parameter/historico_credito_scaler.pkl', 'rb'))
        self.taxa_juros_ajustada_renda              = pickle.load(open('../6_Projeto_Integrador_I/parameter/taxa_juros_ajustada_renda_scaler.pkl', 'rb'))
        self.proporcao_emprestimo_idade             = pickle.load(open('../6_Projeto_Integrador_I/parameter/proporcao_emprestimo_idade_scaler.pkl', 'rb'))
        self.proporcao_emprestimo_tempo_emprego     = pickle.load(open('../6_Projeto_Integrador_I/parameter/proporcao_emprestimo_tempo_emprego_scaler.pkl', 'rb'))
        self.proporcao_emprestimo_historico_credito = pickle.load(open('../6_Projeto_Integrador_I/parameter/proporcao_emprestimo_historico_credito_scaler.pkl', 'rb'))
        self.proporcao_renda_emprestimo             = pickle.load(open('../6_Projeto_Integrador_I/parameter/proporcao_renda_emprestimo_scaler.pkl', 'rb'))
        self.imputer                                = pickle.load(open('../6_Projeto_Integrador_I/parameter/imputed_knn.pkl', 'rb'))

        self.posse_casa                             = pickle.load(open('../6_Projeto_Integrador_I/parameter/posse_casa_label_encoder.pkl', 'rb'))
        self.finalidade_emprestimo                  = pickle.load(open('../6_Projeto_Integrador_I/parameter/finalidade_emprestimo_label_encoder.pkl', 'rb'))
        self.grau_risco_emprestimo                  = pickle.load(open('../6_Projeto_Integrador_I/parameter/grau_risco_emprestimo_label_encoder.pkl', 'rb'))
        self.registro_inadimplencia                 = pickle.load(open('../6_Projeto_Integrador_I/parameter/registro_inadimplencia_label_encoder.pkl', 'rb'))
